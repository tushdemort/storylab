...
const configSchema = z.object({
  ...
  ideationInstructionMarkdown: z.string().trim().min(1),
  ideationPrompt: z.string().trim().min(1),
  discussionInstructionMarkdown: z.string().trim().min(1),
  discussionPrompt: z.string().trim().min(1),
  outlineInstructionMarkdown: z.string().trim().min(1),
  outlinePrompt: z.string().trim().min(1),
  writingInstructionMarkdown: z.string().trim().min(1),
  writingPrompt: z.string().trim().min(1),
  waitSeconds: z.number().int().min(10).max(3600),
  chatSeconds: z.number().int().min(10).max(14400),
  ideationSeconds: z.number().int().min(10).max(14400),
  discussionSeconds: z.number().int().min(10).max(14400),
  outlineSeconds: z.number().int().min(10).max(14400),
  writingSeconds: z.number().int().min(10).max(14400),
